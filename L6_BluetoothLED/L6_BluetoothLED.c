...
static void                     buttonISR(void *data, uint8_t port_pin );
...
uint8_t l5_bluetoothled_l5service_red_client_configuration[] = {BIT16_TO_8(GATT_CLIENT_CONFIG_NONE)};
...
gatt_db_lookup_table l5_bluetoothled_gatt_db_ext_attr_tbl[] =
{
    ...
    {HDLD_L5SERVICE_RED_CLIENT_CONFIGURATION, 2,      2,                                                      l5_bluetoothled_l5service_red_client_configuration},
            ...
            if (l5_bluetoothled_gatt_db_ext_attr_tbl[i].cur_len <= max_len)
            {
                ...
                *p_len = l5_bluetoothled_gatt_db_ext_attr_tbl[i].cur_len;
                ...
                case HDLC_L5SERVICE_RED_VALUE:
                    ...
                    break;
                case HDLD_L5SERVICE_RED_CLIENT_CONFIGURATION:
                    break;
                }
            }
            else
